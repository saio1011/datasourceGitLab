...
public class ContributorUtil {
    ...
    /**
    * Returns the contributor where name = &#63; or throws a {@link de.hska.wi.awp.datasource.gitlab.NoSuchContributorException} if it could not be found.
    *
    * @param name the name
    * @return the matching contributor
    * @throws de.hska.wi.awp.datasource.gitlab.NoSuchContributorException if a matching contributor could not be found
    * @throws SystemException if a system exception occurred
    */
    public static de.hska.wi.awp.datasource.gitlab.model.Contributor findByName(
        java.lang.String name)
        throws com.liferay.portal.kernel.exception.SystemException,
            de.hska.wi.awp.datasource.gitlab.NoSuchContributorException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.hska.wi.awp.datasource.gitlab.model.Contributor fetchByName(
        java.lang.String name)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.hska.wi.awp.datasource.gitlab.model.Contributor removeByName(
        java.lang.String name)
        throws com.liferay.portal.kernel.exception.SystemException,
            de.hska.wi.awp.datasource.gitlab.NoSuchContributorException {
    ...
    */
    public static void cacheResult(
        de.hska.wi.awp.datasource.gitlab.model.Contributor contributor) {
    ...
    */
    public static void cacheResult(
        java.util.List<de.hska.wi.awp.datasource.gitlab.model.Contributor> contributors) {
    ...
    */
    public static de.hska.wi.awp.datasource.gitlab.model.Contributor create(
        long contributorId) {
    ...
    * @return the contributor that was removed
    * @throws de.hska.wi.awp.datasource.gitlab.NoSuchContributorException if a contributor with the primary key could not be found
    * @throws SystemException if a system exception occurred
    */
    public static de.hska.wi.awp.datasource.gitlab.model.Contributor remove(
        long contributorId)
        throws com.liferay.portal.kernel.exception.SystemException,
            de.hska.wi.awp.datasource.gitlab.NoSuchContributorException {
    ...
    public static de.hska.wi.awp.datasource.gitlab.model.Contributor updateImpl(
        de.hska.wi.awp.datasource.gitlab.model.Contributor contributor)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    /**
    * Returns the contributor with the primary key or throws a {@link de.hska.wi.awp.datasource.gitlab.NoSuchContributorException} if it could not be found.
    *
    * @param contributorId the primary key of the contributor
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.hska.wi.awp.datasource.gitlab.model.Contributor findByPrimaryKey(
        long contributorId)
        throws com.liferay.portal.kernel.exception.SystemException,
            de.hska.wi.awp.datasource.gitlab.NoSuchContributorException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static de.hska.wi.awp.datasource.gitlab.model.Contributor fetchByPrimaryKey(
        long contributorId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<de.hska.wi.awp.datasource.gitlab.model.Contributor> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static ContributorPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (ContributorPersistence) PortletBeanLocatorUtil.locate(de.hska.wi.awp.datasource.gitlab.service.ClpSerializer.getServletContextName(),
