...
import de.hska.wi.awp.datasource.gitlab.model.ContributorModel;
import de.hska.wi.awp.datasource.gitlab.model.ContributorSoap;
...
/**
 * The base model implementation for the Contributor service. Represents a row in the &quot;datasourceGitLab_Contributor&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link de.hska.wi.awp.datasource.gitlab.model.ContributorModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ContributorImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ContributorImpl
 * @see de.hska.wi.awp.datasource.gitlab.model.Contributor
 * @see de.hska.wi.awp.datasource.gitlab.model.ContributorModel
 * @generated
 */
@JSON(strict = true)
public class ContributorModelImpl extends BaseModelImpl<Contributor>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a contributor model instance should use the {@link de.hska.wi.awp.datasource.gitlab.model.Contributor} interface instead.
     */
    public static final String TABLE_NAME = "datasourceGitLab_Contributor";
    ...
    public static final String TABLE_SQL_CREATE = "create table datasourceGitLab_Contributor (contributorId LONG not null primary key,name VARCHAR(75) null,email VARCHAR(75) null,commits INTEGER,locAdditions INTEGER,locDeletions INTEGER,projectName VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table datasourceGitLab_Contributor";
    public static final String ORDER_BY_JPQL = " ORDER BY contributor.contributorId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY datasourceGitLab_Contributor.contributorId ASC";
    public static final String DATA_SOURCE = "liferayDataSource";
    public static final String SESSION_FACTORY = "liferaySessionFactory";
    public static final String TX_MANAGER = "liferayTransactionManager";
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.de.hska.wi.awp.datasource.gitlab.model.Contributor"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.de.hska.wi.awp.datasource.gitlab.model.Contributor"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.de.hska.wi.awp.datasource.gitlab.model.Contributor"),
            true);
    public static long NAME_COLUMN_BITMASK = 1L;
    public static long CONTRIBUTORID_COLUMN_BITMASK = 2L;
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.de.hska.wi.awp.datasource.gitlab.model.Contributor"));
