...
import de.hska.wi.awp.datasource.gitlab.model.CommitModel;
import de.hska.wi.awp.datasource.gitlab.model.CommitSoap;
...
/**
 * The base model implementation for the Commit service. Represents a row in the &quot;datasourceGitLab_Commit&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link de.hska.wi.awp.datasource.gitlab.model.CommitModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link CommitImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see CommitImpl
 * @see de.hska.wi.awp.datasource.gitlab.model.Commit
 * @see de.hska.wi.awp.datasource.gitlab.model.CommitModel
 * @generated
 */
@JSON(strict = true)
public class CommitModelImpl extends BaseModelImpl<Commit>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a commit model instance should use the {@link de.hska.wi.awp.datasource.gitlab.model.Commit} interface instead.
     */
    public static final String TABLE_NAME = "datasourceGitLab_Commit";
    ...
    public static final String TABLE_SQL_CREATE = "create table datasourceGitLab_Commit (commitId VARCHAR(75) not null primary key,authorName VARCHAR(75) null,authorEmail VARCHAR(75) null,titleCommit VARCHAR(75) null,createdAt VARCHAR(75) null,projectName VARCHAR(75) null)";
    public static final String TABLE_SQL_DROP = "drop table datasourceGitLab_Commit";
    public static final String ORDER_BY_JPQL = " ORDER BY commit.commitId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY datasourceGitLab_Commit.commitId ASC";
    public static final String DATA_SOURCE = "liferayDataSource";
    public static final String SESSION_FACTORY = "liferaySessionFactory";
    public static final String TX_MANAGER = "liferayTransactionManager";
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.de.hska.wi.awp.datasource.gitlab.model.Commit"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.de.hska.wi.awp.datasource.gitlab.model.Commit"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.de.hska.wi.awp.datasource.gitlab.model.Commit"),
            true);
    ...
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.de.hska.wi.awp.datasource.gitlab.model.Commit"));
